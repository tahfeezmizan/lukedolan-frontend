    ...
    <section className="bg-[#EBF1FA] py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-8">
          ...
          <Link
            href={"/job"}
            className="bg-transparent text-black hover:text-white hover:bg-green-800 border-2 border-green-900 hover:border-green-800 px-8 py-2 text-lg font-medium rounded-none flex items-center justify-between gap-2 duration-300"
          >
            Explore all

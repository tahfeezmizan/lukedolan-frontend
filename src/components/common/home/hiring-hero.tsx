                ...
                <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-center gap-20 mb-8">
                        <div className="space-y-1">
                            <h3 className="text-xl font-bold text-gray-400">{isLoading ? "---" : activeUsers.toLocaleString()}+</h3>
                            <p className="text-sm">Active Users</p>
                        </div>
                        <div className="space-y-1">
                            <h3 className="text-xl font-bold text-gray-400">{isLoading ? "---" : applicationsSubmitted.toLocaleString()}+</h3>

...
export default function AppliedJobsPage() {
    const { data: appliedJobsData, isLoading, error } = useGetAppliedJobsQuery(undefined);
                ...
                <table className="w-full bg-white border border-gray-200">
                    <thead>
                        <tr className="border-b border-gray-200 bg-gray-50">
                            ...
                            <th className="text-left py-4 px-6 font-semibold text-gray-700">Company / Recruiter</th>
                            <th className="text-left py-4 px-6 font-semibold text-gray-700">Location</th>
                            <th className="text-left py-4 px-6 font-semibold text-gray-700">Applied Date</th>

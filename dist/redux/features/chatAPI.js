...
exports.useSendMessageMutation = exports.useGetMessagesQuery = exports.useGetChatsQuery = exports.useCreateChatMutation = void 0;
// src/redux/features/chatApi.js
const baseApi_1 = require("./baseApi");
const chatApi = baseApi_1.baseApi.injectEndpoints({
    endpoints: (builder) => ({
        // ✅ Create chat
        ...
        getMessages: builder.query({
            ...
            forceRefetch({ currentArg, previousArg }) {
                return (currentArg === null || currentArg === void 0 ? void 0 : currentArg.page) !== (previousArg === null || previousArg === void 0 ? void 0 : previousArg.page);
            },
        }),
        // Send a new message
...
exports.useCreateChatMutation = chatApi.useCreateChatMutation, exports.useGetChatsQuery = chatApi.useGetChatsQuery, exports.useGetMessagesQuery = chatApi.useGetMessagesQuery, exports.useSendMessageMutation = chatApi.useSendMessageMutation;

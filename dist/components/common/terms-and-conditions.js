...
function TermsAndConditions() {
    const { data, isLoading, isError } = (0, termsApi_1.useGetTermsQuery)();
    if (isLoading) {
        return ((0, jsx_runtime_1.jsx)("div", { className: "flex justify-center items-center py-20", children: (0, jsx_runtime_1.jsx)("p", { className: "text-gray-600", children: "Loading terms & conditions..." }) }));
    }
    if (isError || !data) {
        return ((0, jsx_runtime_1.jsx)("div", { className: "flex justify-center items-center py-20", children: (0, jsx_runtime_1.jsx)("p", { className: "text-red-600", children: "Failed to load terms & conditions." }) }));
    }
    const content = data.content;
    return ((0, jsx_runtime_1.jsx)("div", { className: "bg-[#EBF1FA]", children: (0, jsx_runtime_1.jsx)("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-20 overflow-hidden", children: (0, jsx_runtime_1.jsxs)("div", { className: "bg-white rounded-lg shadow-sm p-8 md:p-8 mt-10", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Terms & Conditions" }), (0, jsx_runtime_1.jsx)("div", { className: "prose max-w-none text-gray-700", dangerouslySetInnerHTML: { __html: content } })] }) }) }));
}

...
exports.PostJobForm = PostJobForm;
...
function PostJobForm() {
    ...
    const [createJob] = (0, jobsApi_1.useCreateJobMutation)();
    const { data: categories } = (0, categoryApi_1.useGetAllCategoryQuery)(undefined);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.log(res);
            if (res.success) {
                sonner_1.toast.success("✅ Job Createed Sucessfully");
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-6 rounded-lg bg-white", children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-3xl font-bold text-gray-900 mb-6", children: "Post a new job" }), (0, jsx_runtime_1.jsxs)("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4 ", children: [(0, jsx_runtime_1.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [(0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "title", className: "text-lg font-medium text-gray-90", children: "Job Title" }), (0, jsx_runtime_1.jsx)(input_1.Input, Object.assign({ id: "title", placeholder: "Hair Stylist" }, register("title", { required: "Job title is required" }), { className: "mt-1 p-4 rounded-lg !text-lg text-black w-full" })), errors.title && ((0, jsx_runtime_1.jsx)("p", { className: "text-red-500 text-sm", children: errors.title.message }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [(0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "category", className: "text-lg font-medium text-gray-90", children: "Job Category" }), (0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: "category", control: control, rules: { required: "Job category is required" }, render: ({ field }) => ((0, jsx_runtime_1.jsxs)(select_1.Select, { onValueChange: field.onChange, value: field.value, children: [(0, jsx_runtime_1.jsx)(select_1.SelectTrigger, { className: "mt-1 p-4 rounded-lg !text-lg text-black w-full", children: (0, jsx_runtime_1.jsx)(select_1.SelectValue, { placeholder: "Select category" }) }), (0, jsx_runtime_1.jsx)(select_1.SelectContent, { children: Array.isArray(categories) && categories.length > 0 ? (categories.map((category) => ((0, jsx_runtime_1.jsx)(select_1.SelectItem, { value: category === null || category === void 0 ? void 0 : category.name, children: category === null || category === void 0 ? void 0 : category.name }, category._id)))) : ((0, jsx_runtime_1.jsx)("p", { className: "px-2 py-1 text-gray-500 text-sm", children: "No categories found" })) })] })) }), errors.category && ((0, jsx_runtime_1.jsx)("p", { className: "text-red-500 text-sm", children: errors.category.message }))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "space-y-3", children: [(0, jsx_runtime_1.jsx)(label_1.Label, { className: "text-lg font-medium text-gray-90", children: "Employment Type" }), (0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: "type", control: control, rules: { required: "Employment type is required" }, render: ({ field }) => ((0, jsx_runtime_1.jsxs)(radio_group_1.RadioGroup, { value: field.value, onValueChange: field.onChange, className: "flex items-center space-x-8", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center space-x-2", children: [(0, jsx_runtime_1.jsx)(radio_group_1.RadioGroupItem, { value: "Full-time", id: "Full-time" }), (0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "Full-time", className: "text-md font-medium text-gray-600", children: "Full-time" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center space-x-2", children: [(0, jsx_runtime_1.jsx)(radio_group_1.RadioGroupItem, { value: "Remote", id: "Remote" }), (0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "Remote", className: "text-md font-medium text-gray-600", children: "Remote" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center space-x-2", children: [(0, jsx_runtime_1.jsx)(radio_group_1.RadioGroupItem, { value: "Freelance", id: "Freelance" }), (0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "Freelance", className: "text-md font-medium text-gray-600", children: "Freelance" })] })] })) }), errors.type && ((0, jsx_runtime_1.jsx)("p", { className: "text-red-500 text-sm", children: errors.type.message }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [(0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "jobLocation", className: "text-lg font-medium text-gray-90", children: "Job Location" }), (0, jsx_runtime_1.jsx)(input_1.Input, Object.assign({ id: "jobLocation", placeholder: "Hair Stylist" }, register("jobLocation", {
                                    ...
                                    }), { className: "mt-1 p-4 rounded-lg !text-lg text-black w-full" }))] }), (errors.minSalary || errors.maxSalary) && ((0, jsx_runtime_1.jsx)("p", { className: "text-red-500 text-sm", children: "Salary range is required" }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [(0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "experianceLabel", className: "text-lg font-medium text-gray-90", children: "Expricene Level" }), (0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: "experianceLabel", control: control, rules: { required: "Expricene Level is required" }, render: ({ field }) => ((0, jsx_runtime_1.jsxs)(select_1.Select, { onValueChange: field.onChange, value: field.value, children: [(0, jsx_runtime_1.jsx)(select_1.SelectTrigger, { className: "mt-1 p-4 rounded-lg !text-lg text-black w-full", children: (0, jsx_runtime_1.jsx)(select_1.SelectValue, { placeholder: "Select Expricene Level" }) }), (0, jsx_runtime_1.jsxs)(select_1.SelectContent, { children: [(0, jsx_runtime_1.jsx)(select_1.SelectItem, { value: "Experienced", children: "Experienced" }), (0, jsx_runtime_1.jsx)(select_1.SelectItem, { value: "Beginner", children: "Beginner" }), (0, jsx_runtime_1.jsx)(select_1.SelectItem, { value: "Freshers", children: "Freshers" })] })] })) }), errors.experianceLabel && ((0, jsx_runtime_1.jsx)("p", { className: "text-red-500 text-sm", children: errors.experianceLabel.message }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [(0, jsx_runtime_1.jsx)(label_1.Label, { htmlFor: "description", className: "text-lg font-medium text-gray-90", children: "Job Description" }), (0, jsx_runtime_1.jsx)(textarea_1.Textarea, Object.assign({ id: "description", placeholder: "Describe the role" }, register("description", {
                            ...
                            }), { className: "mt-1 p-4 rounded-lg !text-lg text-black w-full min-h-[120px] resize-none" })), errors.responsibilities && ((0, jsx_runtime_1.jsx)("p", { className: "text-red-500 text-sm", children: errors.responsibilities.message }))] }), (0, jsx_runtime_1.jsx)(button_1.Button, { type: "submit", className: "w-full bg-green-900 hover:bg-green-800 text-white px-8 py-6 mt-5 text-lg font-medium rounded-lg", children: "Job post" })] })] }));
}

...
function DropdownMenu(_a) {
    var props = __rest(_a, []);
    return (0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Root, Object.assign({ "data-slot": "dropdown-menu" }, props));
}
function DropdownMenuPortal(_a) {
    var props = __rest(_a, []);
    return ((0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Portal, Object.assign({ "data-slot": "dropdown-menu-portal" }, props)));
}
function DropdownMenuTrigger(_a) {
    var props = __rest(_a, []);
    return ((0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Trigger, Object.assign({ "data-slot": "dropdown-menu-trigger" }, props)));
}
...
function DropdownMenuGroup(_a) {
    var props = __rest(_a, []);
    return ((0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Group, Object.assign({ "data-slot": "dropdown-menu-group" }, props)));
}
...
function DropdownMenuRadioGroup(_a) {
    var props = __rest(_a, []);
    return ((0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.RadioGroup, Object.assign({ "data-slot": "dropdown-menu-radio-group" }, props)));
}
...
function DropdownMenuLabel(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Label, Object.assign({ "data-slot": "dropdown-menu-label", "data-inset": inset, className: (0, utils_1.cn)("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", className) }, props)));
}
function DropdownMenuSeparator(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Separator, Object.assign({ "data-slot": "dropdown-menu-separator", className: (0, utils_1.cn)("bg-border -mx-1 my-1 h-px", className) }, props)));
}
function DropdownMenuShortcut(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("span", Object.assign({ "data-slot": "dropdown-menu-shortcut", className: (0, utils_1.cn)("text-muted-foreground ml-auto text-xs tracking-widest", className) }, props)));
}
function DropdownMenuSub(_a) {
    var props = __rest(_a, []);
    return (0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Sub, Object.assign({ "data-slot": "dropdown-menu-sub" }, props));
}
